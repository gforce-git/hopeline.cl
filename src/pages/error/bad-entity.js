...
// Page class
class BadEntityErrorPage extends FoxComponent {

    // Component strings
    static strings = {
        en: {
            title: 'We have had communication problems',
            description: 'Unfortunately we have not been able to communicate correctly and seamlessly between server and the client. Try clearing your browser cache and try again.',
            back: 'Back to home',
        },
        es: {
            title: 'Hemos tenido problemas con la comunicación',
            description: 'Lamentablemente no hemos podido comunicarnos de manera correcta e íntegra entre el navegador WEB y el Servidor. Intente eliminar el caché de su navegador e inténtelo nuevamente.',
...
export default BadEntityErrorPage;
